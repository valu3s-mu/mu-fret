...
//	if ((! messageK.includes("order"))){//(! messageK.includes("order")) &&
	    //(! messageK.includes("only"))){
		//&&  (! messageK.includes("notin"))) {
...
//      if ((! messageK.includes("not_order"))
	  //&&  (! messageK.includes("only")) &&  (! messageK.includes("notin"))
	 //){

    ...
    // Check has failed. The user should probably never see this
      return(
        ...
        <DialogTitle id="simple-dialog-title">  Extract Requirement Failed: {reqid}
          ...
          <DialogContent>
            <DialogContentText>
              The checks have failed and the refactoring was not performed. Please Close this dialogue, review the variable types and the part of the requirement you were trying to extract, and try again.
            </DialogContentText>

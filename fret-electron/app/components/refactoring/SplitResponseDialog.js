    ...
    // Check has failed. The user should probably never see this
      return(
        ...
        <DialogTitle id="simple-dialog-title">  Split Response Failed: {reqid}
          ...
          <DialogContent>
            <DialogContentText>
              The checks have failed and the refactoring was not performed. Please Close this dialogue, review the variable types and the compatibility of the requirements, and try again.
            </DialogContentText>
